...
// QPluginLoader entry point for the Test Plugin DLL.
//
...
// ABI / metadata.
class TestPluginFactory : public QObject, public IPluginFactory {
    Q_OBJECT
    Q_PLUGIN_METADATA(IID CHARTPLOTTER_PLUGIN_IID FILE "test_plugin.json")
...
// unit.
#include "test_plugin_factory.moc"
